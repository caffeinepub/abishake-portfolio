  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": { boxShadow: "0 0 6px rgba(168,85,247,0.3)" },
          "50%": { boxShadow: "0 0 18px rgba(168,85,247,0.7), 0 0 32px rgba(168,85,247,0.35)" },
        },
        "glow-pulse-cyan": {
          "0%, 100%": { boxShadow: "0 0 6px rgba(34,211,238,0.3)" },
          "50%": { boxShadow: "0 0 18px rgba(34,211,238,0.7), 0 0 32px rgba(34,211,238,0.35)" },
        },
        "slide-in-left": {
      ...
      animation: {
        ...
        "blob-delayed": "blob 25s ease-in-out infinite 5s",
        "blob-slow": "blob 30s ease-in-out infinite 10s",
